...
const val key_timerSecondsCount = "key_timerSeconds"
...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null) {
            ...
            dessertTimer.secondsCount = savedInstanceState.getInt(key_timerSecondsCount,0)
        }
    ...
    override fun onSaveInstanceState(outState: Bundle?) {
        ...
        outState?.putInt(key_timerSecondsCount,dessertTimer.secondsCount)
